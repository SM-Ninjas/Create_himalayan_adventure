    ...
    <div className="container flex flex-col md:flex-row items-center justify-between p-4">
      <div className="md:w-1/2 text-left">
        ...
        <p className='regular-text m-1'>
          ...
          Established in 2015 by a team of passionate experts in travel and tourism, our mission is to offer exceptional adventure experiences while showcasing the diverse natural and cultural heritage of Nepal. We emphasize sustainable and eco-friendly practices in trekking, hiking, and tours. Our team comprises professional trekking and climbing guides, porters, and tour leaders with extensive knowledge of Nepal, Tibet, and Bhutan.
        </p>
        <p className="regular-text mt-2">
          Over the past nine years, we have consistently delivered top-notch services through dedication, professionalism, and passion. We have earned the Certificate of Excellence from Tripadvisor for our outstanding service. In Nepal, we organize extreme sports such as bungee jumping, paragliding, zip-lining, ultra-light flying, rock climbing, and rafting. We offer trekking, hiking, expeditions, and peak-climbing activities in the Everest, Annapurna, Langtang, Manaslu, and Mustang regions. Create Himalaya Adventure also manages and oversees tours including helicopter tours, wildlife safaris, cultural tours, and visits to heritage sites. We provide customized itineraries for groups and individuals, allowing you to plan your adventure based on your schedule, interests, and budget.
        </p>
      </div>
